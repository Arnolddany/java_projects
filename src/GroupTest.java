...
class GroupTest {
    ...
    void getAllStudentsByCondition() {
        ...
        myGroup.addStudent(17, "Dany", myGroup.getGroupName(), 4.5, Student.Sex.male, myGroup.getCourse(), 2);
        myGroup.addStudent(18, "Polina", myGroup.getGroupName(), 4.5, Student.Sex.female, myGroup.getCourse(), 3);
        myGroup.addStudent(20, "Sasha", myGroup.getGroupName(), 4.5, Student.Sex.male, myGroup.getCourse(), 4);
        myGroup.addStudent(16, "Maria", myGroup.getGroupName(), 4.5, Student.Sex.female, myGroup.getCourse(), 5);
        myGroup.addStudent(16, "Maksim", myGroup.getGroupName(), 4.5, Student.Sex.male, myGroup.getCourse(), 6);
        myGroup.addStudent(18, "Elena", myGroup.getGroupName(), 4.5, Student.Sex.female, myGroup.getCourse(), 7);
        myGroup.addStudent(20, "Vanya", myGroup.getGroupName(), 4.5, Student.Sex.male, myGroup.getCourse(), 8);
        myGroup.addStudent(19, "Kristina", myGroup.getGroupName(), 4.5, Student.Sex.female, myGroup.getCourse(), 9);
        myGroup.addStudent(19, "Katya", myGroup.getGroupName(), 4.5, Student.Sex.female, myGroup.getCourse(), 10);
        myGroup.addStudent(17, "Lida", myGroup.getGroupName(), 4.5, Student.Sex.female, myGroup.getCourse(), 11);
